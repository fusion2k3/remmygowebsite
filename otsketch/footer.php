		...
		<footer id="colophon" class="site-footer">
			<div class="grid-container">
				...
				<div class="grid-x grid-padding-x center">
					<div class="col">
						<a href="<?php echo home_url(); ?>" class="logo"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/rg.png" alt="<?php bloginfo( 'name' ); ?>" title="<?php bloginfo( 'name' ); ?>" ></a>
						<?php echo get_field('left_footer_text','options');?>
						<ul class="social">
